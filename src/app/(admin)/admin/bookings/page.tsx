							...
							<Card key={booking.id}>
								<CardHeader>
									<div className="flex items-center justify-between">
										<div>
											...
											<CardDescription>
												Client: {booking.client_name || "Unknown"} | Technician: {booking.technician_name || "Unknown"}
											</CardDescription>
										</div>
								...
								<CardContent>
									<div className="space-y-2 text-sm">
										...
										<p>
											<strong>Preferred Date:</strong> {preferredDate.toLocaleString()}
										</p>
										<p>
											<strong>Description:</strong> {booking.problem_description}
										</p>
										<div className="flex items-center gap-2">
											<input type="checkbox" checked={booking.lead_contacted} readOnly />
											<span>Contacted</span>
											<input type="checkbox" checked={booking.lead_closed} readOnly className="ml-4" />
											<span>Closed</span>
										</div>
									</div>
									<div className="mt-4">

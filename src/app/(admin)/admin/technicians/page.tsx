						...
						<Card key={tech.id}>
							<CardHeader>
								<div className="flex items-center justify-between">
									...
									{tech.is_visible ? <Badge variant="default">Visible</Badge> : <Badge variant="secondary">Hidden</Badge>}
								</div>
							...
							<CardContent>
								<div className="mb-4 space-y-2">
									...
									<p className="text-sm text-muted-foreground">Cities: {Array.isArray(tech.cities) && tech.cities.length > 0 ? tech.cities.join(", ") : "None"}</p>
								</div>
